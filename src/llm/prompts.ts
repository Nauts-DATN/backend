...
export const SUMMARIZE_DOCUMENT_PROMPT = `Bạn là trợ lý giáo dục. Hãy đọc toàn bộ tài liệu đính kèm và tóm tắt bằng tiếng Việt theo cấu trúc sau:

Tổng quan
Viết 2–3 câu mô tả chủ đề chính và mục đích của tài liệu.
